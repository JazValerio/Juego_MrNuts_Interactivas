export class Enemy {
  ...
  update() {
    //chatgpt: Ayudame a controlar que el enemigo se mueva a la vez que el player, cuando este se acerca a un rango específico este lo siga, toma en base este codigo (base del método)
    this.enemies.getChildren().forEach((enemy) => {
      ...
      if (distance < 75) { 
        ...
        this.scene.physics.moveTo(enemy, enemy.originalX, enemy.y, enemy.speed);
      }
    });
  }
